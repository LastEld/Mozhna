...
Модули: money — чистое ядро; main — cookie auth и API; db — records/sessions/jobs/schedules и owner_state для общего лимита входа и блокировок; jobs/worker/scheduler — долговечные задачи; providers — Anthropic/Gemini; mcp_server — read-only remote tools; imports — CSV. recovery — карантин восстановленных jobs/schedules/sessions при остановленном runtime. Инструкции: [RECOVERY](../../docs/RECOVERY.md). Отдельного action executor нет.
