...
Часть работ реализована в alpha; построчное наличие задачи здесь не означает незавершённость всего её кода или прохождение exit gate. [Фактическое покрытие](IMPLEMENTATION.md). Это задачи для разработки, не автоматически созданные GitHub Issues. Стек и облачная форма выбраны: не начинать заново обсуждение языков.
